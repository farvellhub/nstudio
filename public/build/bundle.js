...
var Lightbox = /*#__PURE__*/function () {
  ...
  function Lightbox(config) {
    ...
    this._setLightboxConfig(config); // Init roullette of images


    this._initRoullette();

    console.log(this.config); // Return listen lightbox

    return this.listen();
  }

  _createClass(Lightbox, [{
    key: "_setLightboxConfig",
    value: function _setLightboxConfig(config) {
      this.config = {
        images: _toConsumableArray(document.getElementsByClassName(config.images)),
        texts: _toConsumableArray(document.getElementsByClassName(config.texts)),
        lightbox: {
    ...
    value: function _initRoullette() {
      ...
      this.config.images.forEach(function (img, index) {
        ...
        var image = img.cloneNode(),
            text = _this.config.texts[index]; // Reset image element to lightbox css classes

        (_image$classList = image.classList).remove.apply(_image$classList, _toConsumableArray(image.classList));

        image.classList.add("roullette-image", _this.control); // Pushing images to roullete

        _this.config.roullette.img.appendChild(image);

        _this.config.roullette.txt.push(text.textContent);
    ...
    value: function _setPhoto(src) {
      this.config.lightbox.photo.src = src;
    }
  }, {
    key: "_setCaption",
    value: function _setCaption(text) {
      this.config.lightbox.caption.textContent = text;
    ...
    key: "_updateFromAll",
    value: function _updateFromAll() {
      var photo = this.config.roullette.img.children,
    ...
    value: function _updateFromRoullette(index) {
      var length = this.config.conditions.length,
    ...
    key: "_validUpdate",
    value: function _validUpdate(classList) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _context.abrupt("return", this.handler.onClick(this.config.control, this.conditions).then(console.log("Lightbox is working!")));
...
var LightboxHandler = /*#__PURE__*/function () {
  // ... Animation { element: idName, css: className || [className] }
  ...
  _createClass(LightboxHandler, [{
    ...
    value: function _initAnimations(animations) {
      ...
      animations.forEach(function (anim, index) {
        ...
        _this2._setDefaultAnimation(index);
      });
    } // If css provided is an array
    ...
    value: function _animate() {
      ...
      this.animations.forEach(function (animation) {
        animation.css.forEach(function (cssName) {
          _this3._toggleAnimation(animation.element, cssName);
        });
      });
    ...
    key: "onClick",
    value: function () {
      var _onClick = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(controls, conditions) {
        var _this4 = this;
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                keys = document.querySelectorAll(".".concat(controls));
...
/* harmony import */ var _farvell_jflow_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @farvell/jflow-core */ "./node_modules/@farvell/jflow-core/index.js");
/* harmony import */ var _farvell_jflow_core__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_farvell_jflow_core__WEBPACK_IMPORTED_MODULE_2__);
...
var initMenu = function initMenu() {
  var menu = new _farvell_jflow_core__WEBPACK_IMPORTED_MODULE_2__.Handler({
    element: "menu",
...
var initDocument = function initDocument() {
  var document = new _farvell_jflow_core__WEBPACK_IMPORTED_MODULE_2__.Handler({
    element: "document",
...
window.addEventListener("load", function () {
  initMenu().then(initDocument()).then(new _lightbox__WEBPACK_IMPORTED_MODULE_4__.default({
    images: "grid-image",
    texts: "grid-caption"
  })).then(console.log("Is working..."));
}); // Typed.js

new (typed_js__WEBPACK_IMPORTED_MODULE_3___default())("#typed", {
